				...
				<div class="portlet light">
					<div class="portlet-title">
						<div class="caption" data-toggle="collapse" data-target=".todo-project-list-content">
							<span class="caption-subject font-green-sharp bold uppercase">Tasks</span>
									<span class="caption-helper visible-sm-inline-block visible-xs-inline-block">Click to view task list</span>
								</div>
								<div class="actions">
									<div class="btn-group">
								    ...
								    @else
                                        <ul class="nav nav-pills nav-stacked">
                                            @foreach($mycourses as $course)
                                                <li>
                                                    <a href="javascript:;">
                                                    <span class="badge badge-success"> 6 </span> {{ $course->title }} </a>
                                                </li>
                                            @endforeach
                                        </ul>
                                    @endif
						...
						<div class="portlet light">
							...
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="caption-helper">USER:</span> &nbsp; <span class="caption-subject font-green-sharp bold uppercase">{{ $user->username}}</span>
								</div>
								<div class="actions">
									<div class="btn-group">
